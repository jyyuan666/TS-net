...
"""
IMAGE_INPUT_PATH = './data/VOCdevkit/VOC2007/JPEGImages'
XML_INPUT_PATH = './data/VOCdevkit/VOC2007/Annotations'
IMAGE_OUTPUT_PATH = './data/VOCdevkit/VOC2007/show_output'
