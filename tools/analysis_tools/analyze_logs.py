    ...
    for i, log_dict in enumerate(log_dicts):
        ...
        for j, metric in enumerate(metrics):
            ...
            if 'mAP' in metric:
                ...
                plt.title('AP of SOTA vs. fire-net', fontproperties='Times New Roman',fontsize=10)
                plt.plot(xs, ys, label=legend[i * num_metrics + j], marker=',', linewidth=2)
            else:
                xs = []
                ys = []
                ...
                plt.xlabel('iter')
                plt.title('mAP Data Comparison', fontproperties='Times New Roman', fontsize=10)
                plt.plot(
